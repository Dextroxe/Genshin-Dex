...
class Character {
    constructor(lang, character) {
        var _a, _b, _c;
        const characterAsset = getJsonAssets_1.charactersAssets[character.avatarId];
        ...
        this.icons = {
            avatar: (0, getAssetUrl_1.getAssetUrl)(characterAsset.iconName),
            side: (0, getAssetUrl_1.getAssetUrl)(characterAsset.sideIconName),
        };
        ...
        this.constellation = characterAsset.talents.map((talent) => new index_1.CharacterConstellation(lang, talent, (character === null || character === void 0 ? void 0 : character.talentIdList) || []));
        this.skills = characterAsset.skills.map((skill) => new characterSkill_1.CharacterSkill(lang, skill, (character === null || character === void 0 ? void 0 : character.skillLevelMap[skill]) || 0));
